...
const samples: WireMessage[] = [
  ...
  },
  {
    ...
    run: {
      runId: "run_01HSKILL",
      cardId: "card_01HSKILL",
      prompt: "with skills",
      repoPath: "/tmp/repo",
      baseBranch: "main",
      worktreePath: "/tmp/work/run_01HSKILL",
      branchName: "claude-kanban/run_01HSKILL",
      model: "claude-opus-4-7",
      allowedTools: ["Read", "Write", "Edit"],
      bashAllowlist: [],
      maxTurns: 50,
      diffPath: "/tmp/diffs/run_01HSKILL.patch",
      tracePath: "/tmp/traces/run_01HSKILL.jsonl",
      loadSkills: true,
    },
  },
